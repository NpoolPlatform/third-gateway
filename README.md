...
### 步骤
* 在github上将模板仓库https://github.com/NpoolPlatform/third-gateway.git import为https://github.com/NpoolPlatform/my-service-name.git
* git clone https://github.com/NpoolPlatform/my-service-name.git
* cd my-service-name
* mv cmd/third-gateway cmd/my-service
